...
export default function LogInComponent() {
  ...
  return (
    <div className='my-bg-image flex h-screen w-screen items-center justify-center bg-gray-900 bg-cover bg-no-repeat'>
      <div className='flex min-h-screen items-center p-4 lg:justify-center'>
        <div className=' max flex flex-col overflow-hidden rounded-md bg-white shadow-lg md:flex-1 md:flex-row lg:max-w-screen-md'>
          <div className='bg-indigo-600 p-4 py-6 text-white md:flex md:w-80 md:flex-shrink-0 md:flex-col md:items-center md:justify-evenly'>
            <div className=' my-3 text-center font-bold  tracking-wider'>
              <img src={kywLogo} className='logo my-max-w-150' alt='KYW logo' />
              <a className='text-4xl text-orange-400 ' href=''>
                K Y W
              </a>
            </div>
            <p className='mt-6 text-center font-normal text-gray-300 md:mt-0'>
              With the power of KYW, you can easyly get information of countries
            ...
            <p className='mt-6 text-center text-sm text-gray-300'>
              ...
              <span className='mt-8 flex justify-center text-lg text-black underline'>
          ...
          <div className='bg-white p-5 md:flex-1'>
            ...
            <form action='#' className='flex flex-col space-y-5'>
              ...
              <div className='flex items-center space-x-2'>
                ...
                <a
                  href=''
                  className='text-xs text-blue-600 hover:underline focus:text-blue-800'
                >
                  Forgot Password?
                </a>
              </div>
